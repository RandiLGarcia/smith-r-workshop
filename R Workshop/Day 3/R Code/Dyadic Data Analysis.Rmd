...
The multiple correlation squared can be computed by comparing the error variance for the model to a model with no predictors.
...
Pseudo R^2^ for women is 0.16, or 16% of the variance in satisfaction for women is explained by the model.  
Pseudo R^2^ for men is 0.14, or 14% of the variance in satisfaction for men is explained by the model.  
